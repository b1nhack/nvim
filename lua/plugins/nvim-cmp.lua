  ...
  config = function()
    ...
    cmp.setup({
      ...
      mapping = {
        ...
        ['<C-S-u>'] = cmp.mapping(function(fallback)
      ...
      formatting = {
        format = function(entry, vim_item)
          -- Kind icons
          vim_item.kind = string.format('%s %s', MiniIcons.get('lsp', vim_item.kind), vim_item.kind) -- This concatenates the icons with the name of the item kind
